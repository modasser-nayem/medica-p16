import { Stethoscope, ArrowRight, Play, CheckCircle, Shield, Clock, Calendar, Video, TestTube } from "lucide-react";
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Quick & Easy Scheduling</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Video, Voice & Chat</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
